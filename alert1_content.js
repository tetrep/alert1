...
alert1.make_chrome_notification = function (data) {
  chrome.runtime.sendMessage(data, function(){});
};

alert1.hook_function = function (func_old_in, func_old_scope, func_new_in, func_new_scope, hook_whitelist_check_in, whitelist_in, hook_blacklist_check_in, blacklist_in) {
  var hooked_function = {
...
alert1.default_func_hook = function (input) {
...
alert1.get_stack_trace = function () {
