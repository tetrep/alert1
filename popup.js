alert1.html_settings = [];

alert1.make_html = function () {
...
alert1.make_checkbox = function (name, id) {
...
alert1.update_settings = function () {
  var i = 0;
...
alert1.add_loading_div = function () {
...
alert1.remove_loading_div = function () {
...
alert1.load_settings(alert1.make_html.bind(alert1));
